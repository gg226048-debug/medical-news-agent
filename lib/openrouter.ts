...
export async function summarizeArticle(
  ...
  if (!apiKey) {
    return { summary: content.slice(0, 400), title_ko: title, tags: [] }
  }
        ...
        messages: [
          {
            role: 'system',
            content:
              '당신은 의료/보건 전문 번역가 및 에디터입니다. 영어 의료 뉴스를 한국어로 정확하고 이해하기 쉽게 번역·요약합니다.',
          },
          {
            role: 'user',
            content: `아래 의료 뉴스를 한국어로 번역·요약해주세요.
...
{"title_ko":"한국어 제목","summary":"한국어 3~4문장 요약","tags":["태그1","태그2","태그3"]}`,
          },
        ],
